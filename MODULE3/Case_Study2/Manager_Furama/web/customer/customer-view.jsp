...
<form method="post">
    <div class="container-fluid">
        <h4 style="text-align: center;color: #fd7e14;background-color: darkslategray;height: 40px"> Information Customer</h4>
        <div class="row">
            ...
            <div class="row col-xl-8" style="background-color: ghostwhite">
                ...
                <div class="col-xl-5">
                    ...
                    <div>
                        <br>
                        <a role="button" href="/customer" class="btn btn-danger"  style="margin-left: 120px">Close</a>
                    </div>
                </div>
            </div>
        </div>
