...
//    }
    ...
    public ModelAndView searchByName(@RequestParam("query") String search, @PageableDefault(value = 3) Pageable pageable) {
        ModelAndView modelAndView = new ModelAndView("/blog/list");
        Page<Blog> blogPage = blogService.findAllByNameContaining(search, pageable);
        modelAndView.addObject("list", blogPage);
        return modelAndView;
    }
}
